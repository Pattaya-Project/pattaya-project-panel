...
class PattayaPanelUtil:
    ...
    def panel_log_info(message):
        ...
        PattayaPanelUtil._panel_log_viewer_instance.verticalScrollBar().setValue(PattayaPanelUtil._panel_log_viewer_instance.verticalScrollBar().maximum())
    ...
    def server_log_info(message):
        ...
        PattayaPanelUtil._server_log_viewer_instance.verticalScrollBar().setValue(PattayaPanelUtil._server_log_viewer_instance.verticalScrollBar().maximum())
    ...
    def get_terminal_help():
        ...
        table.rows.append(["url-download", "Drop file from url to bot"])
